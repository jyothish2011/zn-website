...
export default function feature() {
    ...
    return (
        <>
            <section className='bg-home'>
                <div className=' container mx-auto px-4'>
                    <div class=" grid grid-cols-1">
                        <div className='banner-right-fade fade-right banner-animate self-center'>
                            <div className='text-center'>
                                <div className="flex justify-center items-center  mt-36 mb-10 max-sm:mx-14">
                                    <div className="font-family-Raleway 2xl:text-5xl font-bold tracking-[0.02em] text-[#3A3A3A] xl:text-4xl  lg:text-2xl md:text-xl  max-sm:text-2xl">Where power meets simplicity.
                                    </div>
                                </div>
                                <div className='text-center'>
                                    <div className='-mt-5 2xl:text-2xl xl:text-xl lg:text-base md:text-sm  max-sm:text-[10px]  max-sm:justify-center max-sm:items-center tracking-[0.02em] text-[#535353] font-normal'>Experience the essence of efficiency with our focused features.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='banner-left-fade fade-left banner-animate banner-animate flex justify-center items-center'>
                            <div className='mt-12 2xl:w-[592px] 2xl:h-[399px] xl:w-[490px] xl:h-[331px] lg:w-[490px] lg:h-[331px] md:w-[490px] md:h-[331px] max-sm:w-[330px] max-sm:h-[223px]'>
                                <Image src="/../public/feature banner.png" alt="/" width='592' height='399' className='home-image' />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='text-center mt-64 reveal-scroll'>
                <div className="flex justify-center items-center max-sm:-mt-36 mt-56 mb-10 ">
