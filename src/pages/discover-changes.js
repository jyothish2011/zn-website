    ...
    const sections = [
        {
            id: 0, content:
                <div>
                    <section className=' bg-home h-screen' >
                        ...
                        <div className='container px-5 mx-auto pt-10 section'>
                            <div className=" grid grid-cols-5 max-sm:grid-cols-1 max-sm:gap-0  max-sm:hidden">
                                <div className="  col-span-2 max-sm:hidden ">
                                    <div className='left-div-zoom mt-28 ml-10 max-sm:hidden'>
                                        <Image src="/../public/discover-elements.png" alt="/" width="266" height="279" className="" />
                                    </div>
                                    <div className='left-div ml-36 -mt-32 2xl:w-[464px]  max-sm:hidden'>
                                        <Image src="/../public/discover-section.png" alt="/" width="345" height="335" className="" />
                                    </div>
                                </div>
                        ...
                        <div className='container px-5 mx-auto pt-10 '>
                            <div className=" grid grid-cols-5 max-sm:grid-cols-1 max-sm:gap-0  max-sm:hidden">
                                ...
                                <div className="right-div col-span-2 mx-4 max-sm:hidden ">
                                    <div className='right-div-zoom mt-28 ml-10 max-sm:hidden'>
                                        <Image src="/../public/discover-elements-2.png" alt="/" width="266" height="279" className="" />
                                    </div>
                                    <div className='right-div ml-36 -mt-32 2xl:w-[464px]  max-sm:hidden'>
                                        <Image src="/../public/discover-section-2.png" alt="/" width="345" height="335" className="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section>
                        <div className='container px-5 mx-auto  pt-10 '>
                            <div className=" grid grid-cols-5 max-sm:grid-cols-1 max-sm:gap-0  max-sm:hidden">
                                ...
                                <div className="right-div col-span-2 mx-4 max-sm:hidden ">
                                    <div className='right-div-zoom mt-40 ml-2 max-sm:hidden'>
                                        <Image src="/../public/discover-elements-3.png" alt="/" width="190" height="153" className="" />
                                    </div>
                                    <div className=' ml-36 -mt-8 2xl:w-[464px]  max-sm:hidden'>
                                        <Image src="/../public/discover-section-3.png" alt="/" width="345" height="335" className="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section>
                        <div className='container px-5 mx-auto pt-10  '>
                            <div className=" grid grid-cols-5 max-sm:grid-cols-1 max-sm:gap-0  max-sm:hidden">
                                ...
                                <div className="right-div col-span-2 mx-4 max-sm:hidden ">
                                    <div className='right-div-zoom mt-52 ml-0 max-sm:hidden'>
                                        <Image src="/../public/discover-elements-4.png" alt="/" width="272" height="238" className="" />
                                    </div>
                                    <div className=' ml-40 -mt-48   max-sm:hidden'>
                                        <Image src="/../public/discover-section-4.png" alt="/" width="344" height="335" className="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    <section>
                        <div className='container mx-auto px-5 pt-10'>
                            <div className=" grid grid-cols-5 max-sm:grid-cols-1 max-sm:gap-0  max-sm:hidden">
                            <div className="  col-span-2 max-sm:hidden ">
                                    <div className='left-div-zoom mt-28 ml-48 max-sm:hidden'>
                                        <Image src="/../public/discover-elements-5.png" alt="/" width="220" height="194" className="" />
                                    </div>
                                    <div className='left-div ml-2 -mt-20  max-sm:hidden'>
                                        <Image src="/../public/discover-section-5.png" alt="/" width="345" height="335" className="" />
                                    </div>
                                </div>
                                <div className=" right-div col-span-3 max-sm:grid-cols-1">
                                    <div className='px-20 pt-12'>
