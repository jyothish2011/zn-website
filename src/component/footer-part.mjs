...
import { ExploreArrowIcon, ExploreIcon, MinusIcon, PlusIcon } from '../../public/images';
                ...
                <div className=' get-in-touch-bg'>
                    <div className='container mx-auto px-8 '>
                        <div className='grid grid-cols-5 max-sm:grid-cols-1 my-40 '>
                            ...
                            <div className='col-span-2 max-sm:flex max-sm:justify-center max-sm:items-center reveal-scroll'>
                                <div className='card -m-12 max-sm:mt-8 '>
